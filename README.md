в начале необходимо развернуть виртуальное окружение со всеми зависимостями из файла requirements.txt, в моем случае я использую venv сним будет выглядеть так:
